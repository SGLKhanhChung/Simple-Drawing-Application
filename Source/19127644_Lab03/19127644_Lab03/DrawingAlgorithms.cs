...
namespace _19127644_Lab03
{
    ...
    {
		public static void Line(DrawGL newShape, Point pStart, Point pEnd)
		{
		...
		public static void Circle(DrawGL newShape, Point pStart, Point pEnd)
		{
		...
		public static void Rectangle(DrawGL newShape, Point pStart, Point pEnd)
		{
		...
		public static void Ellipse(DrawGL newShape, Point pStart, Point pEnd)
		{
			//Tính tâm ellipse
			Point pCenter = new Point((pStart.X + pEnd.X) / 2, (pStart.Y + pEnd.Y) / 2);
		...
		public static void Triangle(DrawGL newShape, Point pStart, Point pEnd)
		{
		...
		public static void Pengtagon(DrawGL newShape, Point pStart, Point pEnd)
		{
		...
		public static void Hexagon(DrawGL newShape, Point pStart, Point pEnd)
		{
			//Vẽ ngũ giác đều bằng 2 điểm chuột pStart và pEnd
		...
		public static void Polygon(DrawGL newShape)
		{
